...
RSpec.describe SnakyHash::Snake do
  ...
  it "creates a new rash where all the keys are underscored instead of camelcased" do
    ...
    expect(subject.nested).to be_a(described_class)
    ...
    expect(subject.nested_two).to be_a(described_class)
  ...
  it "merges well with a Mash" do
    ...
    expect(merged.nested3).to be_a(described_class)
  ...
  it "updates well with a Mash" do
    ...
    expect(subject.nested3).to be_a(described_class)
  ...
  it "converts an array of Hashes" do
    ...
    expect(subject.nested_three[0]).to be_a(described_class)
    expect(subject.nested_three[0].nested_four).to eq(4)
    expect(subject.nested_three[1]).to be_a(described_class)
