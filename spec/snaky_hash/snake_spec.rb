...
RSpec.describe SnakyHash::Snake do
  ...
  it "merges well with a Mash" do
    ...
    merged.nested3.should be_a(described_class)
  ...
  it "updates well with a Mash" do
    ...
    subject.nested3.should be_a(described_class)
  ...
  it "converts an array of Hashes" do
    ...
    subject.nested_three[0].should be_a(described_class)
    subject.nested_three[0].nested_four.should == 4
    subject.nested_three[1].should be_a(described_class)
  ...
  it "does not transform non-Symbolizable keys" do
    subject[4].should == "not symbolizable"
    subject[:"4"].should be_nil
    subject["4"].should be_nil
    subject.key?("4").should be false
    subject.key?(:"4").should be false
    subject.key?(4).should be true
  end
end
