...
# snaky_hash Rakefile v7.0.0 - 2026-06-29
...
# rake install                                # Build and install snaky_hash-1.0.0.gem in...
# rake install:local                          # Build and install snaky_hash-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template snaky_hash against itse...
